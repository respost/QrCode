...
include_once('common/detector/MathUtils.php');
include_once('common/BitMatrix.php');
include_once('common/BitSource.php');
include_once('common/BitArray.php');
include_once('common/CharacterSetEci.php');
include_once('common/AbstractEnum.php');
...
include_once('common/reedsolomon/GenericGFPoly.php');
include_once('common/reedsolomon/GenericGF.php');
